...
import AssessmentFormEdit from "../../components/assessment/AssessmentFormEdit";
...
const AssessmentEdit: NextPage = () => {
  ...
  const { key, nik, name, day, total_order, result, persentase } = router.query;
